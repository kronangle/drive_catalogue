...
//	
//	@Test
//    public void app_startup_loads_primary_pane() throws IOException {
//        // When: 
//        navigateToPrimaryScene();
//
//        // Then: We should end up at the Primary Pane
//        VBox pane = lookup("#panePrimary").query();
//        assertThat(pane).isNotNull();
//    }
//
...
//        sleep(5000); 
//
//        if (lookup("#panePrimary").tryQuery().isPresent()) {
//            return; 
//        }
//
//        if (lookup("#loginButton_LoginPage").tryQuery().isPresent()) {
//            clickOn("#loginButton_LoginPage");
//            sleep(15000); // Wait for the Google to finish loading
//        }
//        
//    }
//
